...
nix run home-manager/release-26.05 -- --flake .#linux switch
nix run home-manager/release-26.05 -- --flake .#linux-arm switch
# if we want to build for darwin platform
nix run home-manager/release-26.05 -- --flake .#darwin switch
```
...
nix run home-manager/release-26.05 -- --flake .#wsl switch
```
...
nix run home-manager/release-26.05 -- --flake .#linux expire-generations "-1 days"
```
